...
echo "  - Gaussian Splat model: data/intermediates/${EXPERIMENT_NAME}_distortion_corrected/opensplat_output/"
echo "    (Named as: opensplat_output_numiters{NUM_ITERS}_{YYYYMMDD}_{HHMM}.ply)"
echo ""
echo "Logs:"
